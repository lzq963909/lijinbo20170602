...
import lijinbo.bwie.com.lijinbo20170602.adapter.DragAdapter;
import lijinbo.bwie.com.lijinbo20170602.adapter.OtherAdapter;
import lijinbo.bwie.com.lijinbo20170602.bean.Commit;
/** 类用途 管理频道
 * Created by lijinbo on 2017/6/2.
 */

public class TwoActivity extends AppCompatActivity implements OnItemClickListener{
    ...
    private DragAdapter  mUserAdapter;
        ...
        public void initView() {
           ...
           // 将前10条数据中label_text显示在我的频道管理，后10条数据中label_text显示有更多频道
            Intent intent = getIntent();
            List<Commit.DataBean.ComicsBean> list = intent.getParcelableArrayListExtra("list");
